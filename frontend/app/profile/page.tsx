...
/**
 * v3 profile page at /profile — "reference-format portfolio". Server component;
 * only the scrollspy rail and the floating chat widget opt into "use client".
 * All copy lives in lib/profile-data.ts, and empty arrays/nulls there drive the
 * blank placeholder slots. The chat exists ONLY as the floating widget — there
 * is no in-page chat section. Public: not in middleware's protected paths, so
 * visitors read it without logging in. ("/" is the signed-in dashboard.)
 */
export default function ProfilePage() {
  return (
    <div className="dossier-dots flex min-h-screen flex-col bg-background">
      <WithSubnavigation hideSignedOutAuth />
